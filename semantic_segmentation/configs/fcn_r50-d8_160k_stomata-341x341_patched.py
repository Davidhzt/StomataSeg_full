# FCN + ResNet-50 configuration for Stomata dataset (Patched)
# Complete standalone config file
# FCN decoder (Long et al., 2015) + ResNet-50 backbone (He et al., 2016)
...
train_dataloader = dict(
    batch_size=24,  # FCN is lighter, can use larger batch size
    num_workers=24,
...
test_evaluator = dict(type='IoUMetric', iou_metrics=['mIoU'], output_dir='test_results_fcn_r50_patched', keep_results=True)

# optimizer - SGD (standard for FCN)
optim_wrapper = dict(
    type='OptimWrapper',
...
work_dir = './work_dirs/fcn_r50-d8_160k_stomata-341x341_patched'
