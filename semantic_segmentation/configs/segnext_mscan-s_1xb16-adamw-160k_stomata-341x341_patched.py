# SegNeXt + MSCAN-S configuration for Stomata dataset (Patched)
...
test_evaluator = dict(type='IoUMetric', iou_metrics=['mIoU'], output_dir='test_results_patched', keep_results=True)
...
work_dir = './work_dirs/segnext_mscan-s_1xb16-adamw-160k_stomata-341x341_patched'
