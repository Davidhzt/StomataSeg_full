# Mask R-CNN with Swin-T Backbone on Patched Stomata Dataset
#
# 🎯 PATCH-BASED DETECTION with Swin Transformer
#
# Strategy:
#   • Train on 341×341 patches (pores appear relatively larger!)
#   • Use Swin-T (Swin Transformer Tiny) backbone
#   • Expected: Excellent performance on small objects (pores)
#
# Benefits:
#   • Swin-T: Hierarchical vision transformer with shifted windows
#   • Patch-based: Pores 3x larger relatively (8.3% vs 2.8%)
#   • Transformer attention: Better small object detection
#   • Efficient: Swin uses local windows for computational efficiency
...
# =============================================================================
# Model: Mask R-CNN with Swin-T backbone
# =============================================================================
model = dict(
    type='MaskRCNN',
    backbone=dict(
...
train_dataloader = dict(
    batch_size=24,  # Larger batch size with smaller patches
    num_workers=4,
...
# Optimizer with parameter-wise learning rate for Swin Transformer
optim_wrapper = dict(
    type='OptimWrapper',
    paramwise_cfg=dict(
        custom_keys={
...
# =============================================================================
# SUMMARY - Patch-Based Detection with Swin-T
# =============================================================================
# Key Features:
#   • Swin Transformer Tiny backbone (hierarchical with shifted windows)
#   • Patch-based training (341×341) → pores appear 3x larger relatively
#   • Batch size 8 (efficient training)
#   • AdamW optimizer with parameter-wise LR
#
# Expected Performance:
#   • Pore AP: 30-45% (Swin's shifted windows excellent for small objects!)
#   • Guard Cell AP: 55-65%
#   • Complex AP: 60-70%
#   • Overall mAP: 48-60%
#
# Training: ~24-30 hours (efficient transformer architecture)
# =============================================================================
